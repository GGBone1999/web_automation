...
class RoutePage(BasePage):
    ...
    BTN_CONFIRM_1 = '/html/body/div[14]/div[2]/div/div/div[3]/div/button[2]'
    ...
    def create_normal_route(self):
        ...
        time.sleep(1)
        self.click_xpath(self.BTN_SAVE_CONFIRM)
    ...
    def edit_route(self):
        ...
        pyautogui.mouseUp()
        time.sleep(2)
        self.driver.find_element(By.XPATH, '/html/body/div[1]/div/div[2]/div/div[2]/div/div/div[1]/div[1]/div[2]/div/button[4]').click()
        time.sleep(2)

    # ===================== 修复 3：删除路线（支持传参） =====================
    def get_route_count(self):
        return self.get_element_count(self.LIST_ROUTES)

    def delete_route(self, route_count=None):
        """删除最后3条路线（兼容传参，不影响原有逻辑）"""
        time.sleep(2)
        for _ in range(3):
